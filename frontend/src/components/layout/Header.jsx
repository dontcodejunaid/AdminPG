  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-4 sm:px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2.5 sm:gap-3">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-brand-200/80 dark:border-brand-800/80 bg-brand-50/50 dark:bg-brand-950/60 text-xs font-semibold text-brand-900 dark:text-brand-200">
          <ShieldCheck className="w-4 h-4 text-amber-500" />
          <span className="hidden md:inline text-slate-500 dark:text-slate-400">Role:</span>
          <span className="text-brand-900 dark:text-amber-400 font-extrabold">{currentUser?.role || 'Super Admin'}</span>
        </div>
